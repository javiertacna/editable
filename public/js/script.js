var trcopy;
var editing = 0; // 0 significa k se puede editar
var tdediting = 0; // 0 significa k se puede editar
var editingtrid = 0;
var editingtdcol = 0;
...
$(document).ready(function(){
	...
	$(document).on("click","."+editbutton,function(){
		...
		if(id && editing == 0 && tdediting == 0){
			...
			$("."+table+" tr:last-child").fadeOut("slow");
	...
	$(document).on("click","."+cancelbutton,function(){
		...
		$("."+table+" tr:last-child").fadeIn("slow");
		editing = 0;
	});
